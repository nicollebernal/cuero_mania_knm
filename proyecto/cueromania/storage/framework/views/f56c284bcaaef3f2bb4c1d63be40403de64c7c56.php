...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="<?php echo e(route('usuarios.create')); ?>" class="btn btn-primary fa fa-plus">
             Crear Usuario
        </a>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\proyecto\cueromania\resources\views/usuarios/index.blade.php ENDPATH**/ ?>