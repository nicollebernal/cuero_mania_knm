...
<div class="container">
    ...
    <div class="mb-3 text-end">
        <a href="<?php echo e(route('personalizacion.create')); ?>" class="btn btn-primary">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\proyecto\cueromania\resources\views/personalizacion/index.blade.php ENDPATH**/ ?>