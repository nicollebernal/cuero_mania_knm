...
<div class="container">
    ...
    <form action="<?php echo e(route('admi.personalizacion.store')); ?>" method="POST" enctype="multipart/form-data">
        ...
        <!-- ID Usuario primero -->
        <div class="mb-3">
            <label for="id_usuario">Numero Documento</label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\proyecto\cueromania\resources\views/admi/personalizacion/create.blade.php ENDPATH**/ ?>