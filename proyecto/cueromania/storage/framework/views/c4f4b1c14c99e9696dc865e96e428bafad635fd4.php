...
<div class="container mt-4">
    ...
    <a href="<?php echo e(route('admi.ventas.create')); ?>" class="btn btn-primary mb-3">Nueva Venta</a>
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $ventas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $venta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo e(route('admi.ventas.show', $venta)); ?>" class="btn btn-info btn-sm">Ver</a>
                        <a href="<?php echo e(route('admi.ventas.edit', $venta)); ?>" class="btn btn-warning btn-sm">Editar</a>
                        <form action="<?php echo e(route('admi.ventas.destroy', $venta)); ?>" method="POST" class="d-inline">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\proyecto\cueromania\resources\views/admi/ventas/index.blade.php ENDPATH**/ ?>