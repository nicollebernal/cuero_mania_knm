...
class PersonalizacionController extends Controller
{
    ...
    public function update(Request $request, Personalizacion $personalizacion)
    {
        ...
        return redirect()->route('admi.personalizacion.index')->with('success', 'Personalización actualizada exitosamente');
    }

    public function destroy(Personalizacion $personalizacion)
    {
        $personalizacion->delete();
        return redirect()->route('admi.personalizacion.index')->with('success', 'Personalización eliminada exitosamente');
    }
}
